...
class MyGraphTest {
    ...
    fun testAdjList() {
        ...
        assertEquals(5, matrixForTest3?.vertexNumber)
        ...
        assertEquals(4, matrixForTest3?.vertexNumber)
        assertEquals(2, matrixForTest3?.edgesNumber)
        matrixForTest3?.deleteEdge(fourthEdge)
        assertEquals(4, matrixForTest3?.vertexNumber)
        assertEquals(1, matrixForTest3?.edgesNumber)
        assertEquals(mutableSetOf(thirdVertex), (matrixForTest3?.getAdjVertexes(fourthVertex)))
    }
}
